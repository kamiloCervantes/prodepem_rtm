  ...
  public function post(array $data) {
    ...
    try {
      ...
      $node_data = [
        ...
        'field_fecha_emision_tipado' => isset($data['fecha_emision']) ? date('Y-m-d', strtotime($data['fecha_emision'])) : NULL,
        'field_fecha_vencimiento_tipado' => isset($data['vencimiento']) ? date('Y-m-d', strtotime($data['vencimiento'])) : NULL,
